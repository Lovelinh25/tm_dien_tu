package com.example.markethome.excel;
...
public class ServiceExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Service> list;

    public ServiceExcelExporter(List<Service> list) {
        this.list = list;
        workbook = new XSSFWorkbook();
    }

    private void writeHeaderLine() {
        sheet = workbook.createSheet("Dịch vụ");
