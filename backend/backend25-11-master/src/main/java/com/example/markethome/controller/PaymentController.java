...
import com.example.markethome.DTO.TransactionStatusDTO;
import com.example.markethome.Entities.*;
import com.example.markethome.config.PaymentConfig;
import com.example.markethome.model.PaymentRes;
...
public class PaymentController {
    ...
    public ResponseEntity<?> createPayment(@RequestBody BookDTO requestParams) {
        ...
        booking.setStatus(0);
        booking.setAddress(requestParams.getAddress());
        booking.setName(requestParams.getName());
        booking.setPhone(requestParams.getPhone());
